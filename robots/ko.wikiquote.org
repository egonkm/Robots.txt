...
#
 ...
 # robots.txt for http://ko.wikiquote.org/
 #
 # Please note: There are a lot of pages on this site, and there are
 # some misbehaved spiders out there that go _way_ too fast. If you're
 # irresponsible, your access to the site may be blocked.
...
#
#특수기능:검색 및 임의 문서
Disallow: /wiki/%ED%8A%B9%EC%88%98%EA%B8%B0%EB%8A%A5:%EC%9E%84%EC%9D%98%EB%AC%B8%EC%84%9C
Disallow: /wiki/%ED%8A%B9%EC%88%98%EA%B8%B0%EB%8A%A5%3A%EC%9E%84%EC%9D%98%EB%AC%B8%EC%84%9C
