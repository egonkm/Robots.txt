...
#
# Edit at https://fi.wikinews.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
#
# Please check any changes using a syntax validator such as http://tool.motoricerca.info/robots-checker.phtml
# Enter https://fi.wikinews.org/robots.txt as the URL to check.
#
# Poistettavat- ja palautettavat sivut
Disallow: /wiki/Wikiuutiset:Poistoäänestykset
Disallow: /wiki/Wikiuutiset%3APoisto%C3%A4%C3%A4nestykset
Disallow: /wiki/Wikiuutiset:Palautettavat_sivut
Disallow: /wiki/Wikiuutiset%3APalautettavat_sivut
#
# Käyttäjäsivut
Disallow: /wiki/K%C3%A4ytt%C3%A4j%C3%A4:
Disallow: /wiki/Käyttäjä:
...
Disallow: /wiki/Keskustelu_käyttäjästä:
#
# Ylläpitäjyysäänestykset
Disallow: /wiki/Wikiuutiset:Yll%C3%A4pit%C3%A4j%C3%A4t/
Disallow: /wiki/Wikiuutiset:Ylläpitäjät/
#
# Hakukonenäkyvyyden lisäys
Sitemap: https://fi.wikinews.org/w/index.php?title=Special:NewsFeed&feed=sitemap&categories=Julkaistut_artikkelit&namespace=0&count=99999&hourcount=3360&ordermethod=categoryadd
# </pre>