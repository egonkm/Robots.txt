...
#
 #<pre>
#Forsøk på å hindra robotar åtte av søkjemotorar i å ta med seg informasjon frå visse sider på Wikipedia.
#Om koden verkar kan testast på http://tool.motoricerca.info/robots-checker.phtml ved å sjekka URL-en
#http://nn.wikipedia.org/robots.txt
Disallow: /wiki/Brukar:
Disallow: /wiki/Brukar%3A
Disallow: /wiki/Brukardiskusjon
Disallow: /wiki/Wikipedia:Administratorar
Disallow: /wiki/Wikipedia%3AAdministratorar
Disallow: /wiki/Wikipedia-diskusjon:Administratorar
Disallow: /wiki/Wikipedia-diskusjon%3AAdministratorar
Disallow: /wiki/Kategori:Sider_merkte_for_sletting
Disallow: /wiki/Kategori%3ASider_merkte_for_sletting
Disallow: /wiki/Kategoridiskusjon:Sider_merkte_for_sletting
Disallow: /wiki/Kategoridiskusjon%3ASider_merkte_for_sletting
Disallow: /wiki/Spesial:
Disallow: /wiki/Spesial%3A
#</pre>