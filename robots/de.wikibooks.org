...
#
#
 # <!-- Das Leerzeichen vor der Raute bitte stehen lasse. --><pre>
Disallow: /wiki/Wikibooks:Qualitätssicherung/
Disallow: /wiki/Wikibooks:QualitÃ¤tssicherung/
Disallow: /wiki/Wikibooks%3AQualit%C3%A4tssicherung/
Disallow: /wiki/Wikibooks:Löschkandidaten/
Disallow: /wiki/Wikibooks:LÃ¶schkandidaten/
Disallow: /wiki/Wikibooks%3AL%C3%B6schkandidaten/
Disallow: /wiki/Wikibooks:L%C3%B6schkandidaten/
Disallow: /wiki/Wikibooks:Benutzersperrung/
Disallow: /wiki/Wikibooks%3ABenutzersperrung/
Disallow: /wiki/Wikibooks:Vandalensperrung/
Disallow: /wiki/Wikibooks%3AVandalensperrung/
Disallow: /wiki/Wikibooks:Verwaiste_Bücher/
Disallow: /wiki/Wikibooks%3AVerwaiste_Bücher/
Disallow: /wiki/Benutzer_Diskussion
Disallow: /wiki/Wikibooks_Diskussion
# </pre>