...
#
# robots.txt for http://www.wikisource.org/ and friends
#
# Please note: There are a lot of pages on this site, and there are
# some misbehaved spiders out there that go _way_ too fast. If you're
# irresponsible, your access to the site may be blocked.
#
# Edit at http://zh.wikisource.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
#
# Please check any changes using a syntax validator such as http://tool.motoricerca.info/robots-checker.phtml
# Enter http://zh.wikisource.org/robots.txt as the URL to check.
#
...
Sitemap: http://sitemap.wikimedia.org/zhwikisource/latest/zhwikisource-latest-abstract.xml-rss.xml
Sitemap: http://zh.wikisource.org/w/index.php?title=Special:NewPages&feed=rss&namespace=all
