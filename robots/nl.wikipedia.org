...
#
# Deze pagina biedt de mogelijkheid om pagina's af te
# schermen van zoekmachines. De inhoud wordt toegevoegd
# aan nl.wikipedia.org/robots.txt
#
# Voeg geen lege regels toe. Alle regels gelden voor alle
# user-agents.
#
# Controleer wijzigingen met een syntax validator als
# http://tool.motoricerca.info/robots-checker.phtml
# Bekijk robots.txt zelf via nl.wikipedia.org/robots.txt
#
# Voeg niet zomaar pagina's toe. Voor losse pagina's kun
# je [[Sjabloon:Noindex]] gebruiken. Als je alle subpagina's
# wilt afschermen kun je robots.txt gebruiken.
#
# Zie ook: [[Robots Exclusion Protocol]].
#
# <!-- Begin robots.txt -->
#
# Per [[Wikipedia:Stemlokaal/Afscherming voor zoekmachines]]
Disallow: /wiki/Wikipedia:Blokkeringsmeldingen/Blokpeilingen/
Disallow: /wiki/Overleg_Wikipedia:Blokkeringsmeldingen/Blokpeilingen/
Disallow: /wiki/Wikipedia:Regelingen_rond_moderatoren/Bevestiging_moderatorstatus/
Disallow: /wiki/Overleg_Wikipedia:Regelingen_rond_moderatoren/Bevestiging_moderatorstatus/
Disallow: /wiki/Wikipedia:Afzetting_moderatoren/Archief/
Disallow: /wiki/Overleg_Wikipedia:Afzetting_moderatoren/Archief/
Disallow: /wiki/Wikipedia:Aanmelding_moderatoren/
Disallow: /wiki/Overleg_Wikipedia:Aanmelding_moderatoren/
# Per Special:Diff/41829415
Disallow: /wiki/Wikipedia:Arbitragecommissie/Zaken/
Disallow: /wiki/Overleg_Wikipedia:Arbitragecommissie/Zaken/
# Alle verzoekpagina's
Disallow: /wiki/Wikipedia:Verzoekpagina_voor_moderatoren
Disallow: /wiki/Overleg_Wikipedia:Verzoekpagina_voor_moderatoren
Disallow: /wiki/Wikipedia:Misbruikfilter/Foutieve_meldingen/Archief/
#Te beoordelen pagina's
Disallow: /wiki/Wikipedia:Te_beoordelen_pagina's/
Disallow: /wiki/Overleg wikipedia:Te_beoordelen_pagina's/