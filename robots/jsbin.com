...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://static.jsbin.com/css/static-page.css?4.1.8">
  </head>
  <body>
    <img id="dave" src="https://static.jsbin.com/images/dave.min.svg?4.1.8" alt="Dave, the JS Bin bot">
    <div class="wrapper">
