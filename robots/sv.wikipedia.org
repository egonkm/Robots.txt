...
#
#
 # <!-- Det ska vara ett mellanslag först på den här raden --><pre>
# Lines here will be added to the global robots.txt

# Begäran om åtgärder
Disallow: /wiki/Wikipedia:Begäran_om_åtgärder
Disallow: /wiki/Wikipedia:Beg%C3%A4ran_om_%C3%A5tg%C3%A4rder
Disallow: /wiki/Wikipedia:BOÅ
Disallow: /wiki/Wikipedia:BO%C3%85
Disallow: /wiki/Wikipedia%3ABegäran_om_åtgärder
Disallow: /wiki/Wikipedia%3ABeg%C3%A4ran_om_%C3%A5tg%C3%A4rder
Disallow: /wiki/Wikipedia%3ABOÅ
Disallow: /wiki/Wikipedia%3ABO%C3%85

# Begäran om IP-kontroll
Disallow: /wiki/Wikipedia:Begäran_om_IP-kontroll
Disallow: /wiki/Wikipedia:Beg%C3%A4ran_om_IP-kontroll
Disallow: /wiki/Wikipedia:BIK
Disallow: /wiki/Wikipedia%3ABegäran_om_IP-kontroll
Disallow: /wiki/Wikipedia%3ABeg%C3%A4ran_om_IP-kontroll
Disallow: /wiki/Wikipedia%3ABIK

# Anmäl ett fel
Disallow: /wiki/Wikipedia:Anmäl_ett_fel
Disallow: /wiki/Wikipedia%3AAnmäl_ett_fel
Disallow: /wiki/Wikipedia:Anm%C3%A4l_ett_fel
Disallow: /wiki/Wikipedia%3AAnm%C3%A4l_ett_fel
Disallow: /wiki/Wikipedia:Anmäl_ett_fel/
Disallow: /wiki/Wikipedia%3AAnmäl_ett_fel/
Disallow: /wiki/Wikipedia:Anm%C3%A4l_ett_fel/
Disallow: /wiki/Wikipedia%3AAnm%C3%A4l_ett_fel/
Disallow: /wiki/WP:FEL
Disallow: /wiki/WP%3AFEL
Disallow: /wiki/WP:AEF
Disallow: /wiki/WP%3AAEF

# Ansökan om administrativ behörighet
Disallow: /wiki/Wikipedia:Ansökan_om_administrativ_behörighet
Disallow: /wiki/Wikipedia:Ans%C3%B6kan_om_administrativ_beh%C3%B6righet
Disallow: /wiki/Wikipedia:AAB
Disallow: /wiki/Wikipedia%3AAnsökan_om_administrativ_behörighet
Disallow: /wiki/Wikipedia%3AAns%C3%B6kan_om_administrativ_beh%C3%B6righet
Disallow: /wiki/Wikipedia%3AAAB
Disallow: /wiki/Wikipedia:Ansökan_om_administrativ_behörighet/
Disallow: /wiki/Wikipedia:Ans%C3%B6kan_om_administrativ_beh%C3%B6righet/
Disallow: /wiki/Wikipedia%3AAnsökan_om_administrativ_behörighet/
Disallow: /wiki/Wikipedia%3AAns%C3%B6kan_om_administrativ_beh%C3%B6righet/
Disallow: /wiki/Wikipedia:Begäran_om_administratörskap/
Disallow: /wiki/Wikipedia%3ABegäran_om_administratörskap/

# Ansökan om kommentarer/BOK/KAW
Disallow: /wiki/Wikipedia:BOK
Disallow: /wiki/Wikipedia:Begäran_om_kommentarer/
Disallow: /wiki/Wikipedia:Beg%C3%A4ran_om_kommentarer/
Disallow: /wiki/Wikipedia%3ABOK
Disallow: /wiki/Wikipedia%3ABegäran_om_kommentarer/
Disallow: /wiki/Wikipedia%3ABeg%C3%A4ran_om_kommentarer/
Disallow: /wiki/Wikipedia:KAW
Disallow: /wiki/Wikipedia:Kommentarer_om_administrationen_av_Wikipedia/
Disallow: /wiki/Wikipedia%3AKAW
Disallow: /wiki/Wikipedia%3AKommentarer_om_administrationen_av_Wikipedia/

# Namnrymden Diskussion/Talk
Disallow: /wiki/Diskussion:
