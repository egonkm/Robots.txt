...
<script type="text/javascript" src="js/jquery.js" wd_script_id="jquery.js" nonce="YmZiYzE2NGMwNjNhZTczM2NjZmUwOTZiMjk4OWU0MmZjN2MzMGM4NA=="></script>
<style type="text/css" wd_script_id="search_form_style" nonce="YmZiYzE2NGMwNjNhZTczM2NjZmUwOTZiMjk4OWU0MmZjN2MzMGM4NA==">
...
<script type="text/javascript" src="js/jquery-webdriver.js" wd_script_id="jquery-webdriver.js" nonce="YmZiYzE2NGMwNjNhZTczM2NjZmUwOTZiMjk4OWU0MmZjN2MzMGM4NA=="></script>
<script type="text/javascript" src="js/webdriver.js" wd_script_id="webdriver.js" nonce="YmZiYzE2NGMwNjNhZTczM2NjZmUwOTZiMjk4OWU0MmZjN2MzMGM4NA=="></script>
<script type="text/javascript" wd_script_id="search_form_script" nonce="YmZiYzE2NGMwNjNhZTczM2NjZmUwOTZiMjk4OWU0MmZjN2MzMGM4NA==">
...
<style type="text/css" wd_script_id="featureboxes_style" nonce="YmZiYzE2NGMwNjNhZTczM2NjZmUwOTZiMjk4OWU0MmZjN2MzMGM4NA==">
		.wd_featurebox_icon {
			display: inline;
		}
...
<script type="text/javascript" wd_script_id="view_printable_script" nonce="YmZiYzE2NGMwNjNhZTczM2NjZmUwOTZiMjk4OWU0MmZjN2MzMGM4NA==">
...
<style type="text/css" wd_script_id="toolbar_style" nonce="YmZiYzE2NGMwNjNhZTczM2NjZmUwOTZiMjk4OWU0MmZjN2MzMGM4NA==">
			div.wd_toolbar {
...
<script src="https://cdn.bttrack.com/universal/44152" async></script>
 ...
 <meta property="og:url" content="https://newsroom.ie.paypal-corp.com/404-page-not-found" />
	...
	<link rel="alternate" href="https://newsroom.ie.paypal-corp.com/news?pagetemplate=rss" type="application/rss+xml" title="PayPal Newsroom">	<!-- END MediaRoom Styles -->
	...
	<script type="application/json" id="policy-data">
		{
			...
			"nonce":"test",
			"tenant":"newsroom",
			"policyData": { "country":"IE", "language":"en" }
		}
	</script>
	...
	<!-- Google Tag Manager --> 
	<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0], j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src= 'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f); })(window,document,'script','dataLayer','GTM-56FBDQ2');</script> 
...
<link rel="canonical" href="https://newsroom.ie.paypal-corp.com/404-page-not-found" />
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-56FBDQ2" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> 
<!-- End Google Tag Manager (noscript) -->

	<header class="">
		<nav class="navbar navbar-expand-lg bg-light">
			<div class="wd_logo-wrap"><a class="navbar-brand" href="https://newsroom.ie.paypal-corp.com/home"><img src="images/Newsroom Logo.png"></a></div>
			<!-- Start Mobile Search  -->
			<div class="mobile_search-container">
				<div class="wd_search_form_container"><form name="basic_search" method="get" action="https://newsroom.ie.paypal-corp.com/search-results" class="wd_search_form wd_search_form_basic"><input type="hidden" name="s" value="search_results" /><input type="text" name="query" value="" size="32" placeholder="Search..." title="Search..." /> <input type="submit" name="submit" value="Search"></form>
</div>			</div>
			<!-- END Mobile Search -->
...
<div id="wd_featurebox-standard_3541" class="wd_featurebox_container wd_featurebox-standard"><div class="wd_featurebox_title">Taxonomy menu (current list)</div><div class="wd_featurebox"><div class="container justify-content-center">
<div class="row py-2" style="width: 100%;">
<div class="col-sm-6">
<h4><a href="stories?cat=13" class="wd_local">People</a></h4>
<a class="dropdown-item wd_local" href="stories?cat=14">Culture</a> <a class="dropdown-item wd_local" href="stories?cat=15">Diversity, Inclusion, Equity and Belonging</a></div>

<div class="col-sm-6">
<h4><a href="stories?cat=17" class="wd_local">Performance</a></h4>
<a class="dropdown-item wd_local" href="stories?cat=19">Strategic Partnerships</a> <a class="dropdown-item wd_local" href="stories?cat=6">Social Impact</a></div>
</div>
</div></div></div></div>
				</div>
			</li>
...
<div class="wd_toolbar wd_toolbar-main"><ul class="wd_tools"><li class="wd_tool wd_tool-print"><span class="wd_tool_icon"><a onclick="view_printable(); return false;" rel="nofollow" href="#print" title="print"><span class="fa fa-print"></span></a></span></li><li class="wd_tool wd_tool-socialshare_facebook"><span class="wd_tool_icon">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnewsroom.ie.paypal-corp.com%2Findex.php%3Fs%3D20307" target="_blank" title="Facebook Share" style="background-color:#4267B2;">
                    <span class="fa fa-facebook"></span>
		    <span class="wd_sr-only wd_sr-only-focusable">Facebook Share</span>
                    </a>
                </span></li><li class="wd_tool wd_tool-socialshare_linkedin"><span class="wd_tool_icon">
                    <a href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fnewsroom.ie.paypal-corp.com%2Findex.php%3Fs%3D20307" target="_blank" title="Linkedin Share" style="background-color:#0077B5;">
                    <span class="fa fa-linkedin"></span>
		    <span class="wd_sr-only wd_sr-only-focusable">LinkedIn Share</span>
                    </a>
                </span></li><li class="wd_tool wd_tool-socialshare_twitter"><span class="wd_tool_icon">
                    <a href="https://twitter.com/share?url=https%3A%2F%2Fnewsroom.ie.paypal-corp.com%2Findex.php%3Fs%3D20307" target="_blank" title="Twitter Share" style="background-color:#000;">
                    <span class="fa fa-twitter"></span>
		    <span class="wd_sr-only wd_sr-only-focusable">Twitter Share</span>
                    </a>
                </span></li><li class="wd_tool wd_tool-email"><span class="wd_tool_icon"><a onclick="window.location.href = 'mailto:?subject=Page%20not%20found%20-%20PayPal&amp;body='+encodeURIComponent(window.location.href);return false;" href="#email" title="Email link"><span class="fa fa-envelope"></span><span class="wd_sr-only wd_sr-only-focusable">Email link</span></a></span></li></ul></div>
</div>
</div>				</div>
			</div>
		</div>
				...
				<div class="row">
						...
						<div class="col-md-3 col-sm-12">
							<div class="wd_footer-logo">
								...
								<p><a href="https://www.paypal.com/ie/home" target="_blank">PayPal.com</a><br>
...
<ul>
	...
	<li><a href="https://newsroom.uk.paypal-corp.com/">UK</a></li>
						...
						<div class="col-md-3 col-sm-12 wd_social" style="display:none;">
...
<noscript>
	<img src="https://stats.drivetheweb.com/piwik.php?idsite=6061&rec=1" style="border:0" alt="" />
</noscript>
<!-- End Piwik Tracking Code -->
		
<!-- end spin_special_output(body_end) -->
<script>(function(){if (!document.body) return;var js = "window['__CF$cv$params']={r:'88979f379a5303aa',t:'MTcxNjY2MjA5Mi4wODEwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
</html>
