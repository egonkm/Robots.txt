...
<script type="text/javascript" src="js/jquery.js" wd_script_id="jquery.js" nonce="NmVhMGMzMzY4MTc4YWYzZjhjMTljMTJmYmFlYTE5ZjlhMDYwYTVlMA=="></script>
<style type="text/css" wd_script_id="search_form_style" nonce="NmVhMGMzMzY4MTc4YWYzZjhjMTljMTJmYmFlYTE5ZjlhMDYwYTVlMA==">
...
<script type="text/javascript" src="js/jquery-webdriver.js" wd_script_id="jquery-webdriver.js" nonce="NmVhMGMzMzY4MTc4YWYzZjhjMTljMTJmYmFlYTE5ZjlhMDYwYTVlMA=="></script>
<script type="text/javascript" src="js/webdriver.js" wd_script_id="webdriver.js" nonce="NmVhMGMzMzY4MTc4YWYzZjhjMTljMTJmYmFlYTE5ZjlhMDYwYTVlMA=="></script>
<script type="text/javascript" wd_script_id="search_form_script" nonce="NmVhMGMzMzY4MTc4YWYzZjhjMTljMTJmYmFlYTE5ZjlhMDYwYTVlMA==">
...
<style type="text/css" wd_script_id="featureboxes_style" nonce="NmVhMGMzMzY4MTc4YWYzZjhjMTljMTJmYmFlYTE5ZjlhMDYwYTVlMA==">
		.wd_featurebox_icon {
			display: inline;
		}
...
<script type="text/javascript" wd_script_id="view_printable_script" nonce="NmVhMGMzMzY4MTc4YWYzZjhjMTljMTJmYmFlYTE5ZjlhMDYwYTVlMA==">
...
<style type="text/css" wd_script_id="toolbar_style" nonce="NmVhMGMzMzY4MTc4YWYzZjhjMTljMTJmYmFlYTE5ZjlhMDYwYTVlMA==">
			div.wd_toolbar {
...
<script src="https://cdn.bttrack.com/universal/44152" async></script>
 ...
 <meta property="og:url" content="https://newsroom.paypal-corp.com/404-page-not-found" />
...
<link rel="canonical" href="https://newsroom.paypal-corp.com/404-page-not-found" />
<!-- end spin_special_output(head_end) -->
</head>
	

<body class="wd_pageid_20315" nonce="test">
...
<!-- End Google Tag Manager (noscript) -->
	...
	<header class="">
		...
		<nav class="navbar navbar-expand-lg bg-light">
			<div class="wd_logo-wrap"><a class="navbar-brand" href="https://newsroom.paypal-corp.com/home"><img src="images/Newsroom Logo.png"></a></div>
			<!-- Start Mobile Search  -->
...
<a class="dropdown-item" href="stories?cat=17">Culture</a> <a class="dropdown-item" href="stories?cat=18">Diversity, Inclusion, Equity and Belonging</a> <a class="dropdown-item" href="stories?cat=19">Volunteerism</a></div>

<div class="col-sm-3">
<h4><a href="stories?cat=14">Performance</a></h4>
<a class="dropdown-item" href="stories?cat=1">Corporate Announcements</a> <a class="dropdown-item" href="stories?cat=21">PayPal Ventures</a> <a class="dropdown-item" href="stories?cat=22">Strategic Partnerships</a> <a class="dropdown-item" href="stories?cat=6">Social Impact</a></div>

<div class="col-sm-3">
<h4><a href="stories?cat=15">Innovation</a></h4>
<a class="dropdown-item" href="stories?cat=24">Cryptocurrency</a> <a class="dropdown-item" href="stories?cat=25">Digital Wallet</a> <a class="dropdown-item" href="stories?cat=26">Buy Now, Pay Later</a> <a class="dropdown-item" href="stories?cat=27">QR Code</a><a class="dropdown-item" href="stories?cat=28"> Business Lending</a> <a class="dropdown-item" href="stories?cat=29">Credit</a> <a class="dropdown-item" href="stories?cat=30">Technology</a></div>
</div>
</div>
</div></div></div>
				</div>
...
<div class="wd_toolbar wd_toolbar-main"><ul class="wd_tools"><li class="wd_tool wd_tool-print"><span class="wd_tool_icon"><a onclick="view_printable(); return false;" rel="nofollow" href="#print" title="Print"><span class="fa fa-print"></span><span class="wd_sr-only wd_sr-only-focusable">Print</span></a></span></li><li class="wd_tool wd_tool-socialshare_linkedin"><span class="wd_tool_icon">
                    <a href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fnewsroom.paypal-corp.com%2Findex.php%3Fs%3D20315" target="_blank" title="Linkedin Share" style="background-color:#0077B5;">
		    ...
		    <span class="wd_sr-only wd_sr-only-focusable">LinkedIn Share</span>
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnewsroom.paypal-corp.com%2Findex.php%3Fs%3D20315" target="_blank" title="Facebook Share" style="background-color:#4267B2;">
                    <span class="fa fa-facebook"></span>
		    <span class="wd_sr-only wd_sr-only-focusable">Facebook Share</span>
                    </a>
                </span></li><li class="wd_tool wd_tool-socialshare_twitter"><span class="wd_tool_icon">
                    <a href="https://twitter.com/share?url=https%3A%2F%2Fnewsroom.paypal-corp.com%2Findex.php%3Fs%3D20315" target="_blank" title="Twitter Share" style="background-color:#000;">
...
<a href="https://newsroom.paypal-corp.com/contact" target="_self">Contact Us</a>
	...
	function containsImage() {
		$('.wd_item:not([class^="wd_asset"]), .item').each(function(){
	...
	function toolbar() {
	//Adds AddThis Toolbar after standard content section
		//$('<div class="addthis_inline_share_toolbox"></div>').insertAfter('.wd_standard-detail');	
	//Adds Toolbar before standard detail content section
		$('.wd_toolbar.wd_toolbar-detail').clone().prependTo('.wd_standard-detail');	
	//Adds AddThis Toolbar to container defined in microtemplate
		//$('<div class="addthis_inline_share_toolbox"></div>').appendTo('.wd_tools-wrap');
	//Prepends "Share Article" text to the AddThis Toolbar 
		//$('.addthis_inline_share_toolbox').prepend('<p class="addthis_text">Share</p>');
	}
...
<script type="text/plain" class="optanon-category-2">
  ...
  _paq.push(["setCustomVariable", 3, "Navigation Page", "404", "page"]);
...
<script>(function(){if (!document.body) return;var js = "window['__CF$cv$params']={r:'88979f8d08382156',t:'MTcxNjY2MjEwNS43MzcwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
</html>
