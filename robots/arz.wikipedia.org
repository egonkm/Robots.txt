...
#
# Localisable part of robots.txt for arz.wikipedia.org
#
# Edit at https://arz.wikipedia.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
...
# Enter https://arz.wikipedia.org/robots.txt as the URL to check.
#
