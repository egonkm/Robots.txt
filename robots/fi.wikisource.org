...
#
# Edit at http://fi.wikisource.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
#
# Please check any changes using a syntax validator such as http://tool.motoricerca.info/robots-checker.phtml
# Enter http://fi.wikisource.org/robots.txt as the URL to check.
#
# Poistettavat- ja palautettavat sivut
Disallow: /wiki/Wikiaineisto:Poistettavat_sivut
Disallow: /wiki/Wikiaineisto%3APoistettavat_sivut
Disallow: /wiki/Wikiaineisto:Palautettavat_sivut
Disallow: /wiki/Wikiaineisto%3APalautettavat_sivut
#
# Käyttäjäsivut
Disallow: /wiki/K%C3%A4ytt%C3%A4j%C3%A4:
Disallow: /wiki/Käyttäjä:
...
Disallow: /wiki/Wikiaineisto:Yll%C3%A4pit%C3%A4j%C3%A4t/
Disallow: /wiki/Wikiaineisto:Ylläpitäjät/
