...
#
#
 # <!-- Lasciare questa linea esattamente com'è. --><pre>
#
# robots.txt for //it.wikipedia.org/ and friends
#
# Please note: There are a lot of pages on this site, and there are
# some misbehaved spiders out there that go _way_ too fast. If you're
# irresponsible, your access to the site may be blocked.
# 
# Edit at //it.wikipedia.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
#
# Please check any changes using a syntax validator such as http://tool.motoricerca.info/robots-checker.phtml
# Enter //it.wikipedia.org/robots.txt as the URL to check.
#
Disallow: /wiki/Speciale:PaginaCasuale
Disallow: /wiki/Speciale%3APaginaCasuale
Disallow: /wiki/Speciale:Ricerca
Disallow: /wiki/Speciale%3ARicerca
Disallow: /wiki/Special:PaginaCasuale
Disallow: /wiki/Special%3APaginaCasuale
Disallow: /wiki/Special:Ricerca
Disallow: /wiki/Special%3ARicerca
#
# it: - //bugzilla.wikimedia.org/show_bug.cgi?id=5545
Disallow: /wiki/Wikipedia:Pagine_da_cancellare/
Disallow: /wiki/Wikipedia%3APagine_da_cancellare/
Disallow: /wiki/Wikipedia:Utenti_problematici/
Disallow: /wiki/Wikipedia%3AUtenti_problematici/
...
Disallow: /wiki/Discussioni_progetto%3ACococo/
# added 2008-09-18
Disallow: /wiki/Wikipedia:Richieste_agli_amministratori/
Disallow: /wiki/Wikipedia%3ARichieste_agli_amministratori/
Disallow: /wiki/Utente:RevertBot/Report/
Disallow: /wiki/Utente%3ARevertBot/Report/
Disallow: /wiki/Wikipedia:Check_user/Richieste/
Disallow: /wiki/Wikipedia%3ACheck_user/Richieste/
Disallow: /wiki/Wikipedia:Cambiare_il_nome_utente/
Disallow: /wiki/Wikipedia%3ACambiare_il_nome_utente/
Disallow: /wiki/Wikipedia:Benvenuto_Bot/Report
Disallow: /wiki/Wikipedia%3ABenvenuto_Bot/Report
# added 2008-10-06
Disallow: /wiki/Wikipedia:Pagina_delle_prove/
Disallow: /wiki/Wikipedia%3APagina_delle_prove/
#added 2008-12-19
Disallow: /wiki/Wikipedia:Cestino/
Disallow: /wiki/Wikipedia%3ACestino/
#added 2009-01-27
Disallow: /wiki/Discussioni_Wikipedia:Utenti_problematici/
Disallow: /wiki/Discussioni_Wikipedia%3AUtenti_problematici/
#added 2010-11-01
Allow: /wiki/Discussioni_Wikipedia:Pagine_da_cancellare/Archivio/
Allow: /wiki/Discussioni_Wikipedia%3APagine_da_cancellare/Archivio/
#added 2010-07-20
Disallow: /wiki/Wikipedia:Richieste_di_pareri/Comportamenti_degli_utenti/
Disallow: /wiki/Wikipedia%3ARichieste_di_pareri/Comportamenti_degli_utenti/
Disallow: /wiki/Discussioni_Wikipedia:Pagine_da_cancellare/
Disallow: /wiki/Discussioni_Wikipedia%3APagine_da_cancellare/
#added 2012-11-19
Disallow: /wiki/MediaWiki:Titleblacklist
Disallow: /wiki/MediaWiki%3Titleblacklist
# </pre>