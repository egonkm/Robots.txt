...
# robots.txt สำหรับ http://th.wikibooks.org/
# แก้ไขที่ http://th.wikibooks.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
# อย่าเพิ่มบรรทัดใหม่ที่นี้ กฎทั้งหมดที่ตั้งค่าไว้ในที่นี้มีผลกระทบต่อผู้ใช้ทั้งหมด
#
# โปรดตรวจสอบการเปลี่ยนแปลงใด ๆ โดยใช้เครื่องมือตรวจสอบไวยากรณ์ เช่น http://tool.motoricerca.info/robots-checker.phtml
# ไปที่ URL http://th.wikibooks.org/robots.txt เพื่อตรวจสอบ
#
# ห้ามเก็บดัชนีใด ๆ ในเนมสเปซมีเดียวิกิ
Disallow: /wiki/มีเดียวิกิ:Spam-blacklist
Disallow: /wiki/มีเดียวิกิ%3ASpam-blacklist
#
# ห้ามเก็บดัชนีใด ๆ ในเนมสเปซวิกิตำรา
Disallow: /wiki/วิกิตำรา:แจ้งขอความช่วยเหลือจากผู้ดูแลระบบ
Disallow: /wiki/วิกิตำรา%3Aแจ้งขอความช่วยเหลือจากผู้ดูแลระบบ
Disallow: /wiki/วิกิตำรา:แจ้งขอความช่วยเหลือจากผู้ดูแลระบบ/
Disallow: /wiki/วิกิตำรา%3Aแจ้งขอความช่วยเหลือจากผู้ดูแลระบบ/
Disallow: /wiki/วิกิตำรา:เสนอชื่อเพื่อเป็นผู้ดูแล
Disallow: /wiki/วิกิตำรา%3Aเสนอชื่อเพื่อเป็นผู้ดูแล
Disallow: /wiki/วิกิตำรา:เสนอชื่อเพื่อเป็นผู้ดูแล/
Disallow: /wiki/วิกิตำรา%3Aเสนอชื่อเพื่อเป็นผู้ดูแล/
#
# ห้ามเก็บดัชนีใด ๆ ในเนมสเปซหมวดหมู่
Disallow: /wiki/หมวดหมู่:หน้าที่ไม่มีดัชนี
Disallow: /wiki/หมวดหมู่%3Aหน้าที่ไม่มีดัชนี
