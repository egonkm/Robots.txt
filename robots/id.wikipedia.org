...
#
 #<pre>
Disallow: /wiki/Pengguna:
Disallow: /wiki/Pengguna%3A
Disallow: /wiki/Pembicaraan_Pengguna:
Disallow: /wiki/Pembicaraan_Pengguna%3A
Disallow: /wiki/Pembicaraan_Wikipedia:
Disallow: /wiki/Pembicaraan_Wikipedia%3A
Disallow: /wiki/Pembicaraan_Kategori:
Disallow: /wiki/Pembicaraan_Kategori%3A
Disallow: /wiki/Pembicaraan_Templat:
Disallow: /wiki/Pembicaraan_Templat%3A
Disallow: /wiki/Pembicaraan_Modul:
Disallow: /wiki/Pembicaraan_Modul%3A
Disallow: /wiki/Wikipedia:Usulan_penghapusan/
Disallow: /wiki/Wikipedia%3AUsulan_penghapusan/
# </pre>