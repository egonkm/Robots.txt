...
#
# Localisable part of robots.txt for incubator.wikimedia.org
#
# Edit at http://incubator.wikimedia.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
...
# Enter http://incubator.wikimedia.org/robots.txt as the URL to check.