...
#
# Localisable part of robots.txt for ar.wikipedia.org
#
# Edit at https://ar.wikipedia.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
...
# Enter https://ar.wikipedia.org/robots.txt as the URL to check.
#
...
Disallow: /wiki/MediaWiki_talk:Spam-blacklist
Disallow: /wiki/MediaWiki_talk%3ASpam-blacklist
Disallow: /wiki/ميدياويكي:Anonnotice
Disallow: /wiki/سليم_دبور
#
# </pre>