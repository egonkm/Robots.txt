...
#
#
 # <!-- Please do not remove the space at the start of this line, it breaks the rendering.  http://www.robotstxt.org/orig.html says spaces before comments are OK. --><source lang="robots">
# robots.txt for http://en.wikibooks.org/
# Edit at http://en.wikibooks.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
...
# Enter http://en.wikibooks.org/robots.txt as the URL to check.
#
# Don't index anything in the MediaWiki namespace
Disallow: /wiki/MediaWiki:
Disallow: /wiki/MediaWiki%3A
#
# Don't index anything in the Transwiki namespace
Disallow: /wiki/Transwiki:
Disallow: /wiki/Transwiki%3A
#
# Don't index discussions
Disallow: /wiki/Category_talk%3A
Disallow: /wiki/Category_talk:
Disallow: /wiki/Cookbook_talk%3A
Disallow: /wiki/Cookbook_talk:
Disallow: /wiki/File_talk%3A
Disallow: /wiki/File_talk:
Disallow: /wiki/Help_talk%3A
Disallow: /wiki/Help_talk:
Disallow: /wiki/MediaWiki_talk%3A
Disallow: /wiki/MediaWiki_talk:
Disallow: /wiki/Subject_talk%3A
Disallow: /wiki/Subject_talk:
Disallow: /wiki/Talk%3A
Disallow: /wiki/Talk:
Disallow: /wiki/Template_talk%3A
Disallow: /wiki/Template_talk:
Disallow: /wiki/Transwiki_talk%3A
Disallow: /wiki/Transwiki_talk:
Disallow: /wiki/User_talk%3A
Disallow: /wiki/User_talk:
Disallow: /wiki/Wikibooks%3AFeatured_books/Nominations
Disallow: /wiki/Wikibooks%3AFeatured_books/Nominations/
Disallow: /wiki/Wikibooks%3AReading_room
Disallow: /wiki/Wikibooks%3AReading_room/
Disallow: /wiki/Wikibooks%3ARequests_for_deletion
Disallow: /wiki/Wikibooks%3ARequests_for_deletion/
Disallow: /wiki/Wikibooks%3ARequests_for_import
Disallow: /wiki/Wikibooks%3ARequests_for_import/
Disallow: /wiki/Wikibooks%3ARequests_for_permissions
Disallow: /wiki/Wikibooks%3ARequests_for_permissions/
Disallow: /wiki/Wikibooks%3ARequests_for_renaming
Disallow: /wiki/Wikibooks%3ARequests_for_renaming/
Disallow: /wiki/Wikibooks:Featured_books/Nominations
Disallow: /wiki/Wikibooks:Featured_books/Nominations/
Disallow: /wiki/Wikibooks:Reading_room
Disallow: /wiki/Wikibooks:Reading_room/
Disallow: /wiki/Wikibooks:Requests_for_deletion
Disallow: /wiki/Wikibooks:Requests_for_deletion/
Disallow: /wiki/Wikibooks:Requests_for_import
Disallow: /wiki/Wikibooks:Requests_for_import/
Disallow: /wiki/Wikibooks:Requests_for_permissions
Disallow: /wiki/Wikibooks:Requests_for_permissions/
Disallow: /wiki/Wikibooks:Requests_for_renaming
Disallow: /wiki/Wikibooks:Requests_for_renaming/
Disallow: /wiki/Wikibooks_talk%3A
Disallow: /wiki/Wikibooks_talk:
Disallow: /wiki/Wikijunior_talk%3A
Disallow: /wiki/Wikijunior_talk:
#
