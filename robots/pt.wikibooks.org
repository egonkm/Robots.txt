...
#
# Localisable part of robots.txt for pt.wikibooks.org
#
# Edit at http://pt.wikibooks.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
# Don't add newlines here. All rules set here are active for every user-agent.
#
# Por favor confira quaisquer alterações usando um validador de sintaxe tal como http://tool.motoricerca.info/robots-checker.phtml
# Coloque http://pt.wikibooks.org/robots.txt como a URL a ser verificada.
#
Disallow: /wiki/Wikilivros:Páginas_eliminadas
Disallow: /wiki/Wikilivros:Páginas_eliminadas/
Disallow: /wiki/Wikilivros_Discussão:Páginas_eliminadas
Disallow: /wiki/Wikilivros_Discussão:Páginas_eliminadas/
Disallow: /wiki/Wikilivros:P%C3%A1ginas_eliminadas
Disallow: /wiki/Wikilivros:P%C3%A1ginas_eliminadas/
Disallow: /wiki/Wikilivros_Discussão:P%C3%A1ginas_eliminadas
Disallow: /wiki/Wikilivros_Discussão:P%C3%A1ginas_eliminadas/
Disallow: /wiki/Wikilivros:Pedidos_de_elimina%C3%A7%C3%A3o_de_imagens
Disallow: /wiki/Wikilivros_Discussão:Pedidos_de_elimina%C3%A7%C3%A3o_de_imagens
Disallow: /wiki/Wikilivros:Pedidos_de_elimina%C3%A7%C3%A3o_de_p%C3%A1ginas
Disallow: /wiki/Wikilivros_Discussão:Pedidos_de_elimina%C3%A7%C3%A3o_de_p%C3%A1ginas
Disallow: /wiki/Wikilivros:Deletion_log
Disallow: /wiki/Wikilivros_Discussão:Deletion_log
#
Disallow: /wiki/Categoria:Páginas_não_indexadas
Disallow: /wiki/Categoria:P%C3%A1ginas_n%C3%A3o_indexadas
# </source>