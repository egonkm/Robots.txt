...
<script type="text/javascript" src="js/jquery.js" wd_script_id="jquery.js" nonce="MTQ2MmU0ZDZhYWZlNDJiOTUzODliMDA3ZTMzM2YyZGIxNDAzNGU3Ng=="></script>
<style type="text/css" wd_script_id="search_form_style" nonce="MTQ2MmU0ZDZhYWZlNDJiOTUzODliMDA3ZTMzM2YyZGIxNDAzNGU3Ng==">
...
<script type="text/javascript" src="js/jquery-webdriver.js" wd_script_id="jquery-webdriver.js" nonce="MTQ2MmU0ZDZhYWZlNDJiOTUzODliMDA3ZTMzM2YyZGIxNDAzNGU3Ng=="></script>
<script type="text/javascript" src="js/webdriver.js" wd_script_id="webdriver.js" nonce="MTQ2MmU0ZDZhYWZlNDJiOTUzODliMDA3ZTMzM2YyZGIxNDAzNGU3Ng=="></script>
<script type="text/javascript" wd_script_id="search_form_script" nonce="MTQ2MmU0ZDZhYWZlNDJiOTUzODliMDA3ZTMzM2YyZGIxNDAzNGU3Ng==">
...
<style type="text/css" wd_script_id="featureboxes_style" nonce="MTQ2MmU0ZDZhYWZlNDJiOTUzODliMDA3ZTMzM2YyZGIxNDAzNGU3Ng==">
		.wd_featurebox_icon {
			display: inline;
		}
...
<script type="text/javascript" wd_script_id="view_printable_script" nonce="MTQ2MmU0ZDZhYWZlNDJiOTUzODliMDA3ZTMzM2YyZGIxNDAzNGU3Ng==">
...
<style type="text/css" wd_script_id="toolbar_style" nonce="MTQ2MmU0ZDZhYWZlNDJiOTUzODliMDA3ZTMzM2YyZGIxNDAzNGU3Ng==">
			div.wd_toolbar {
...
<script src="https://cdn.bttrack.com/universal/44152" async></script>
 ...
 <meta property="og:url" content="https://newsroom.latam.paypal-corp.com/404-page-not-found" />
	...
	<link rel="alternate" href="https://newsroom.latam.paypal-corp.com/ultimas-noticias?pagetemplate=rss" type="application/rss+xml" title="Últimas noticias">	<!-- END MediaRoom Styles -->
	...
	<!-- Google Tag Manager --> 
	<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0], j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src= 'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f); })(window,document,'script','dataLayer','GTM-KK834V3');</script> 
...
<link rel="canonical" href="https://newsroom.latam.paypal-corp.com/404-page-not-found" />
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KK834V3" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> 
<!-- End Google Tag Manager (noscript) -->

	<header class="">	
		<nav class="navbar navbar-expand-lg bg-light">
			<div class="wd_logo-wrap"><a class="navbar-brand" href="https://newsroom.latam.paypal-corp.com/inicio"><img src="images/Newsroom Logo.png"></a></div>
			<!-- Start Mobile Search  -->
			<div class="mobile_search-container">
				<div class="wd_search_form_container"><form name="basic_search" method="get" action="https://newsroom.latam.paypal-corp.com/index.php?s=20322" class="wd_search_form wd_search_form_basic"><input type="hidden" name="s" value="search_results" /><input type="text" name="query" value="" size="32" placeholder="Buscar" title="Buscar" /> <input type="submit" name="submit" value="Buscar"></form>
</div>			</div>
			<!-- END Mobile Search -->
...
<div class="col-sm-3">
<h4><a href="blog?cat=4">Producto</a></h4>
<a class="dropdown-item" href="blog?cat=2">PayPal</a> <a class="dropdown-item" href="blog?cat=12">Zettle</a></div>

<div class="col-sm-3">
<h4><a href="blog?cat=13">Comunidad</a></h4>
<a class="dropdown-item" href="blog?cat=14">Cultura</a> <a class="dropdown-item" href="blog?cat=15">Diversidad, Inclusi&oacute;n, Equidad y Pertenencia (Diversidad e Inclusi&oacute;n - I&amp;D)</a></div>

<div class="col-sm-3">
<h4><a href="blog?cat=1">Corporativo</a></h4>
<a class="dropdown-item" href="blog?cat=20">Alianza Estrat&eacute;gicas</a> <a class="dropdown-item" href="blog?cat=21">Impacto Social</a></div>

<div class="col-sm-3">
<h4><a href="blog?cat=22">Innovaci&oacute;n</a></h4>
<a class="dropdown-item" href="blog?cat=24">PayPal App</a> <a class="dropdown-item" href="blog?cat=25">Meses Sin Intereses</a> <a class="dropdown-item" href="blog?cat=29">Tecnolog&iacute;a</a></div>
</div>
</div>
</div></div></div>
				</div>
			...
			<li id="wd_topnav-20295" class="nav-item ">
				<a href="ultimas-noticias" class="nav-link" target="_self">Noticias</a>
			</li>
			...
			<li id="wd_topnav-20316" class="nav-item ">
				<a href="https://about.pypl.com/home/default.aspx" class="nav-link ">Acerca de PayPal <i class="fa fa-external-link" aria-hidden="true"></i></a></li>
			<li id="wd_topnav-20320" class="nav-item ">
				<a href="https://newsroom.paypal-corp.com/contact" class="nav-link " target="_blank">Contacto <i class="fa fa-external-link" aria-hidden="true"></i></a></li>
		</ul>
...
<div id="globalNavDropdown" class="collapse wd_global navbar-collapse">
	<ul class="navbar-nav">
		...
		<div class="dropdown-menu">
			<div class="container-fluid justify-content-end">
				<div class="row py-2" style="width: 100%;">
					<div class="col-md-2 ml-auto mr-3">
						<h4>Norteamérica</h4>
						<a class="dropdown-item" href="https://newsroom.paypal-corp.com">Global / EUA (Inglés)</a>
						...
						<a class="dropdown-item" href="https://newsroom.latam.paypal-corp.com/">Latinoamérica (Español)</a>
					</div>
					...
					<div class="col-md-2 mr-5">
						<h4>Asia Pacífico</h4>
						<a class="dropdown-item" href="https://newsroom.apac.paypal-corp.com/">Asia Pacífico (Inglés)</a>
						<a class="dropdown-item" href="https://newsroom.au.paypal-corp.com/">Autralia (Inglés)</a>
			...
			<div class="wd_search_wrapper">
				...
				<div class="wd_search-icon"><img src="images/Search_Icon.svg" alt="Buscar PayPal Sala de Prensa"></div>
	...
	<div class="wd_hide-me">
		<div class="wd_global_search">
			<div class="wd_search_form_container"><form name="basic_search" method="get" action="https://newsroom.latam.paypal-corp.com/index.php?s=20322" class="wd_search_form wd_search_form_basic"><input type="hidden" name="s" value="search_results" /><input type="text" name="query" value="" size="32" placeholder="Búsqueda" title="Búsqueda" /> <input type="submit" name="submit" value="Ir"></form>
</div><!-- END SITE SEARCH -->
		</div>
	</div>
		...
		<div class="container wd_content-container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1 class="page_header">Lo sentimos. Esa página no existe.</h1>
					<div id="wd_printable_content"><p>No encontramos ninguna p&aacute;gina con la direcci&oacute;n URL especificada.</p>
...
<div class="wd_toolbar wd_toolbar-main"><ul class="wd_tools"><li class="wd_tool wd_tool-print"><span class="wd_tool_icon"><a onclick="view_printable(); return false;" rel="nofollow" href="#print" title="print"><span class="fa fa-print"></span></a></span></li><li class="wd_tool wd_tool-socialshare_facebook"><span class="wd_tool_icon">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnewsroom.latam.paypal-corp.com%2Findex.php%3Fs%3D20307" target="_blank" title="Facebook Share" style="background-color:#4267B2;">
                    <span class="fa fa-facebook"></span>
		    <span class="wd_sr-only wd_sr-only-focusable"></span>
                    </a>
                </span></li><li class="wd_tool wd_tool-socialshare_linkedin"><span class="wd_tool_icon">
                    <a href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fnewsroom.latam.paypal-corp.com%2Findex.php%3Fs%3D20307" target="_blank" title="Linkedin Share" style="background-color:#0077B5;">
                    <span class="fa fa-linkedin"></span>
		    <span class="wd_sr-only wd_sr-only-focusable">Comparte LinkedIn</span>
                    </a>
                </span></li><li class="wd_tool wd_tool-socialshare_twitter"><span class="wd_tool_icon">
                    <a href="https://twitter.com/share?url=https%3A%2F%2Fnewsroom.latam.paypal-corp.com%2Findex.php%3Fs%3D20307" target="_blank" title="Twitter Share" style="background-color:#000;">
...
<div id="wd_featurebox-standard_3538" class="wd_featurebox_container wd_featurebox-standard"><div class="wd_featurebox_title">Mantente al día.</div><div class="wd_featurebox"><p>Inscr&iacute;bete y recibe las &uacute;ltimas noticias por correo electr&oacute;nico</p>
			...
			<div class="wd_footer-top">
				<div class="row">
						...
						<div class="col-md-6 col-sm-12 wd_link-list">
							<h4>Nuestros Newsrooms globales</h4>
...
<ul>
	...
	// Add Read More link to Related Articles
		$('.wd_related-content.wd_rounded-square .wd_related-wrap-new').each(function() {
			...
			$('<div class="wd_read-more"><a href="'+link+'" aria-label="leer más sobre '+text+'">Leer más</a></div>').insertAfter($(this).find('.wd_related-headline-more'));
		});
...
<script type="text/plain" class="optanon-category-2">
  ...
  (function() {
    ...
    _paq.push(["setSiteId", 5937]);
    var d=document, g=d.createElement("script"), s=d.getElementsByTagName("script")[0];
    g.type="text/javascript"; g.async=true; g.defer=true; g.src=u+"piwik.js"; s.parentNode.insertBefore(g,s);
  })();
</script>
<noscript>
	<img src="https://stats.drivetheweb.com/piwik.php?idsite=5937&rec=1" style="border:0" alt="" />
</noscript>
<!-- End Piwik Tracking Code -->
		
<!-- end spin_special_output(body_end) -->
<script>(function(){if (!document.body) return;var js = "window['__CF$cv$params']={r:'88979fe2f88214f5',t:'MTcxNjY2MjExOS41MzAwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
</html>
