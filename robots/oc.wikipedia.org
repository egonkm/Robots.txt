...
#
 # <pre>
#
# partida robots.txt per http://oc.wikipedia.org/ solament
#
# Una partida generala per totes los sits es aponduda aldessús d'
# aquesta dins http://oc.wikipedia.org/robots.txt
#
# Mercés de verificar cada modificacion amb un verificador de sintaxi
# coma http://tool.motoricerca.info/robots-checker.phtml
...
#
# Nom localizat de las paginas especialas
#
Disallow: /wiki/Special:Pagina_a_l'azard
Disallow: /wiki/Special%3APagina_a_l'azard
Disallow: /wiki/Special:Recèrca
Disallow: /wiki/Special%3ARecèrca

#
# Autras paginas
#
Disallow: /wiki/Wikipèdia:Paginas_de_suprimir/
Disallow: /wiki/Wikipèdia:Paginas_sospechadas_de_violacion_de_copyright/
