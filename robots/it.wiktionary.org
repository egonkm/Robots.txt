...
#
# robots.txt for http://it.wiktionary.org/ and friends
#
# Please note: There are a lot of pages on this site, and there are
# some misbehaved spiders out there that go _way_ too fast. If you're
# irresponsible, your access to the site may be blocked.
# 
# Edit at http://it.wiktionary.org/w/index.php?title=MediaWiki:Robots.txt&action=edit
#
# Please check any changes using a syntax validator such as http://tool.motoricerca.info/robots-checker.phtml
# Enter http://it.wiktionary.org/robots.txt as the URL to check.
#
...
# CANCELLAZIONI
# it: - http://bugzilla.wikimedia.org/show_bug.cgi?id=5545 (per it.wiki)
Disallow: /wiki/Wikizionario:Pagine_da_cancellare/
Disallow: /wiki/Wikizioanrio%3APagine_da_cancellare/
Disallow: /wiki/Categoria:Da_cancellare_subito
Disallow: /wiki/Categoria%3ADa_cancellare_subito

#ADMIN e BUROCRATI
Disallow: /wiki/Wikizionario:Amministratori/
Disallow: /wiki/Wikizioanrio%3AAmministratori/
Disallow: /wiki/Wikizionario:Richieste_agli_amministratori/
Disallow: /wiki/Wikizioanrio%3ARichieste_agli_amministratori/
Disallow: /wiki/Wikizionario:Cambiare_il_nome_utente/
Disallow: /wiki/Wikizioanrio%3ACambiare_il_nome_utente/
Disallow: /wiki/Wikizionario:Benvenuto_Bot/Report
Disallow: /wiki/Wikizioanrio%3ABenvenuto_Bot/Report

# SANDBOX
Disallow: /wiki/Wikizionario:Pagina_delle_prove/
Disallow: /wiki/Wikizioanrio%3APagina_delle_prove/
Disallow: /wiki/Wikizionario:Sandbox/
Disallow: /wiki/Wikizioanrio%3ASandbox/

# Vandali & CO.
Disallow: /wiki/Wikizionario:Utenti_problematici/
Disallow: /wiki/Wikizioanrio%3AUtenti_problematici/
Disallow: /wiki/Wikizionario:Vandalismi_in_corso/
Disallow: /wiki/Wikizioanrio%3AVandalismi_in_corso/

##TALK
Disallow: /wiki/Discussioni_Wikizionario:Utenti_problematici/
Disallow: /wiki/Discussioni_Wikizioanrio%3AUtenti_problematici/
